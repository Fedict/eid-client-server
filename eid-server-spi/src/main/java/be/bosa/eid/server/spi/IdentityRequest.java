...
public class IdentityRequest implements Serializable {
	 ...
	 * Main constructor.
	 *
	 * @param includeIdentity     Marks whether the eID operation should also deliver the eID identity data.
	 * @param includeAddress      Marks whether the eID operation should also deliver the eID address data.
	 * @param includePhoto        Marks whether the eID operation should also deliver the eID photo.
	 * @param includeCertificates Marks whether the eID operation should also deliver the eID certificates.
	 * @param removeCard          Marks whether the eID card should be removed after eID operation.
	 */
