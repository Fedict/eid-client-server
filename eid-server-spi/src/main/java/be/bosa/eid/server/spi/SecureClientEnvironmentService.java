...
public interface SecureClientEnvironmentService {
	 ...
	 * application.
	 *
	 * @param javaVersion         the version of the Java JRE on the client machine.
	 * @param javaVendor          the vendor of the Java JRE on the client machine.
	 * @param osName              the name of the operating system on the client machine.
