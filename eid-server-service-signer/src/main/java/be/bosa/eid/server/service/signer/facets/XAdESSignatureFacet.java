...
import be.bosa.eid.server.service.signer.jaxb.xades132.AnyType;
...
import be.bosa.eid.server.service.signer.jaxb.xades132.ClaimedRolesListType;
import be.bosa.eid.server.service.signer.jaxb.xades132.DataObjectFormatType;
import be.bosa.eid.server.service.signer.jaxb.xades132.DigestAlgAndValueType;
import be.bosa.eid.server.service.signer.jaxb.xades132.IdentifierType;
import be.bosa.eid.server.service.signer.jaxb.xades132.ObjectFactory;
import be.bosa.eid.server.service.signer.jaxb.xades132.ObjectIdentifierType;
import be.bosa.eid.server.service.signer.jaxb.xades132.QualifyingPropertiesType;
import be.bosa.eid.server.service.signer.jaxb.xades132.SigPolicyQualifiersListType;
import be.bosa.eid.server.service.signer.jaxb.xades132.SignaturePolicyIdType;
import be.bosa.eid.server.service.signer.jaxb.xades132.SignaturePolicyIdentifierType;
import be.bosa.eid.server.service.signer.jaxb.xades132.SignedDataObjectPropertiesType;
import be.bosa.eid.server.service.signer.jaxb.xades132.SignedPropertiesType;
import be.bosa.eid.server.service.signer.jaxb.xades132.SignedSignaturePropertiesType;
import be.bosa.eid.server.service.signer.jaxb.xades132.SignerRoleType;
import be.bosa.eid.server.service.signer.jaxb.xmldsig.DigestMethodType;
import be.bosa.eid.server.service.signer.jaxb.xmldsig.X509IssuerSerialType;
import be.bosa.eid.server.service.signer.time.Clock;
import be.bosa.eid.server.service.signer.time.LocalClock;
