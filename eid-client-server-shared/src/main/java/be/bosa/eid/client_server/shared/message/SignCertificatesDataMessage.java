...
public class SignCertificatesDataMessage extends AbstractProtocolMessage {
	 ...
	 * Main Constructor.
	 *
	 * @param identityFile     optional
	 * @param addressFile      optional
	 * @param photoFile        optional
	 * @param identitySignFile optional
	 * @param addressSignFile  optional
	 * @param nrnCertFile      optional
	 */
