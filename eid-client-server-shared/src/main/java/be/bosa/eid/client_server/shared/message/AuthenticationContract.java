...
public class AuthenticationContract {
	 ...
	 * Main constructor.
	 *
	 * @param salt                     salt for authentication
	 * @param hostname                 the optional hostname.
	 * @param inetAddress              the optional internet address.
	 * @param sessionId                the optional SSL session identifier.
	 * @param encodedServerCertificate the optional DER encoded X509 server certificate.
